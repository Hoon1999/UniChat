...
import webchat.knung.controller.ChattingRoomEditForm;
...
public class ChatService {
    ...
    public void updateChattingRoom(ChattingRoomEditForm form) throws IOException {
        ...
        if(form.getRoomImage().isEmpty()) {
            ...
            //String savePath = "C:/spring_boot_images/" + storedFileName; // windows 용 경로. 해당 폴더가 있어야 한다. 없으면 안만들어주나봄.
            String savePath = "/Users/kjhoon44/Desktop/spring_images/" + storedFileName;
            file.transferTo(new File(savePath));

            result.setChatRoomImg(savePath);
        }
